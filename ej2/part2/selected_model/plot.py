"""EJ2 part2 — Plots para el modelo seleccionado."""
import os
import pickle
import sys
...
def main():
    ...
    ax.set_ylabel("Score")
    ax.set_title("EJ2 modelo seleccionado — Métricas por clase (test, 5 seeds)")
    ax.legend()
    ...
    summary = f"""EJ2 — Modelo seleccionado
...
"""
    ...
    # Para cada clase real i: top-2 clases predichas distintas a i,
    # con su porcentaje respecto al total de muestras reales de i.
